...
with col2:
    ...
    <p>Select a position from your chosen category.</p>
...
st.caption(
    "Check your selected position and required skills."
)
...
if st.button(
    ...
    if not user_skills.strip():
        ...
        if recommendations.empty:
            ...
            st.success(
                "🎉 Top 5 matching job opportunities "
            ...
            st.caption(
                "Match percentage is based on your "
                "skills and selected position."
            )
